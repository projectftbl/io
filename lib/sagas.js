...
import { SIGN_ON_SUCCESS, RELOAD_SUCCESS, VERIFY_SUCCESS, SIGN_OUT_SUCCESS } from '@recipher/session-web';

import { CONNECTED } from './duck';
...
export default [ signedOn, reloaded, verified, signedOut ];